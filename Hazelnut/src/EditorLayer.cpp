...
#include "QuantumEngine/Scene/SceneSerializer.h"

#include "QuantumEngine/Utils/PlatformUtils.h"

#include "ImGuizmo/ImGuizmo.h"

#include "QuantumEngine/Math/Math.h"
...
namespace Quantum {
	...
	void EditorLayer::OnAttach()
	{
		...
		fbSpec.Width = 1280;
		fbSpec.Height = 720;
		m_Framebuffer = Framebuffer::Create(fbSpec);		// Create frame buffer here
	...
	void EditorLayer::OnUpdate(Timestep ts)
	{
		...
		if (mouseX >= 0 && mouseY >= 0 && mouseX < (int)viewportSize.x && mouseY < (int)viewportSize.y)
		{
			...
			QT_CORE_WARN("Pixel data = {0}", pixelData);
		}
